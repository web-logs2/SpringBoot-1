...
public class LeaveMsg extends Contract {
    ...
    public static final String FUNC_RETEST = "retest";
    ...
    public Flowable<ValueChangedEventResponse> valueChangedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, ValueChangedEventResponse>() {
            @Override
    ...
    public RemoteFunctionCall<BigInteger> retest() {
        final Function function = new Function(FUNC_RETEST, 
                Arrays.<Type>asList(), 
    ...
    public static RemoteCall<LeaveMsg> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(LeaveMsg.class, web3j, credentials, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<LeaveMsg> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(LeaveMsg.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<LeaveMsg> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(LeaveMsg.class, web3j, transactionManager, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<LeaveMsg> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(LeaveMsg.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
